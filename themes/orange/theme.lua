...
theme.base = awful.util.get_configuration_dir() .. "themes/orange"
...
function theme:init()
	...
	self.widget.tasklist = {
		...
		char_digit  = 5,     -- number of characters in task element text
		...
		task        = theme.gauge.task.blue -- style for task gauge widget
	}
	...
	self.desktop.textset = {
		font  = "Belligerent Madness 22",         -- font
		spacing = 10,               -- space between lines
		color = theme.desktop.color -- color (desktop used)
	}
